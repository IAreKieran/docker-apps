...
docker run --rm -d --net=host -v /tmp/.X11-unix:/tmp/.X11-unix -v /home/kieran/Desktop/games:/home/dolphin-emu/games -v /home/kieran/projects/docker-apps/dolphin-emu/data:/home/dolphin-emu/.local/share -e DISPLAY=unix$DISPLAY --name=dolphin-emu docker-apps:dolphin-emu
