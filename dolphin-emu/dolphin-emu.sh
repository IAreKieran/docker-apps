...
docker run --rm -d --net=host -v /tmp/.X11-unix:/tmp/.X11-unix -v /home/kieran/Desktop/games:/home/dolphin-emu/games -v /home/kieran/projects/docker-apps/dolphin-emu/data/.local:/home/dolphin-emu/.local/share/dolphin-emu -v /home/kieran/projects/docker-apps/dolphin-emu/data/.config:/home/dolphin-emu/.config/dolphin-emu -e DISPLAY=unix$DISPLAY --name=dolphin-emu docker-apps:dolphin-emu
